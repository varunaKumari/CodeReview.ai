...
/**
 * CodeReview.ai brand color palette.
 * Deep blue/indigo primary with emerald accent for a professional code-review aesthetic.
 */
const brandColors = {
  primary: {
    50: '#eef2ff',
...
/**
 * Shared Tailwind CSS v4 configuration for the CodeReview.ai monorepo.
 *
 * Provides a unified design system including:
 * - Brand color palette (indigo primary, emerald accent)
 ...
 * import sharedConfig from '@codereview-ai/config/tailwind-config';
 * import type { Config } from 'tailwindcss';
 *
 * const config: Config = {
 *   ...sharedConfig,
